...
private:
	...
	ALLEGRO_FONT *font20;
public:
	GameScreen(ALLEGRO_BITMAP *playerImage, ALLEGRO_BITMAP *bulletImage, ALLEGRO_BITMAP *zombieImage, ALLEGRO_BITMAP *healthBarSpriteSheet, ALLEGRO_BITMAP *skullImage, ALLEGRO_BITMAP *gameoverImage, ALLEGRO_BITMAP *potionImage, ALLEGRO_BITMAP *ZombieDeathAnimationSpriteSheet1);
	~GameScreen();
	void newGame();
	void update();
	void draw();
